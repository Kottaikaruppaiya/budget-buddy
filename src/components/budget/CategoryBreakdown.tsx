...
const CategoryBreakdown: React.FC<CategoryBreakdownProps> = ({ month }) => {
  ...
  const categoryData = useMemo(() => {
    // Filter by month if provided, otherwise use all transactions
    ...
    // Initialize all expense categories to zero
    ...
    // Convert to array format for chart and filter out zero amounts
